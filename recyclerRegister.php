<?php
 ...
 if ($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    $sql = "INSERT INTO `users` (`fname`, `lname`, `email`, `mobile`, `pass`, `location`, `isRecycler`, `timestamp`) VALUES ('$fname', '$lname', '$email', '$mobile', '$password', '$location', 'yes', current_timestamp());";
    if($conn->query($sql)){
  ...
  <div class="content" >
    <div class="login-page">
      ...
      <img class="logo" src="../junkout (1)/img/New Logo black.png">
        ...
        <form id="reg" action="recyclerRegister.php" class="register-form" autocomplete="on" method="POST" >
          <div class="full-name">
